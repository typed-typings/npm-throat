...
declare module '~throat~es6-promise/dist/es6-promise' {
...
declare module '~throat~es6-promise' {
export * from '~throat~es6-promise/dist/es6-promise';
}

// Generated by typings
// Source: index.d.ts
declare module '~throat/index' {
import { Promise } from '~throat~es6-promise';

function throat <T extends Function> (concurrency: number, worker: T): T;
function throat (promise: typeof Promise): <T> (concurrency: number, worker: T) => T;

export = throat;
}
declare module 'throat/index' {
import main = require('~throat/index');
export = main;
}
